...
user_info = Canvas(home_frame, width=230, height=330,
                   bg="#FCE9F1", highlightthickness=0)
user_info.place(x=640, y=240)

username = Label(home_frame, text="Username", font=(
    "Arial", 17, "bold"), bg="#FCE9F1", fg="#3AA6B9")
username.place(x=500, y=250)
user_info.create_line(10, 45, 220, 45, fill="#164B60", width=3)
user_username = Entry(home_frame, width=18, font="Arial, 15",
                      borderwidth=0, readonlybackground="#FCE9F1", fg="#FFA41B")
...
user_interest = LabelFrame(home_frame, width=220,
                           height=365, bg="blue", borderwidth=0)
...
mylist = Listbox(user_interest, font=("Arial", 17),
                 yscrollcommand=scrollbar.set, relief="flat", bg="#FCE9F1")
...
relation_type = Text(profile_frame, height=6, width=10,
                     font=("Ariel", 16), bg="#FCE9F1", relief="flat")
...
right_btn1 = Button(profile_frame, image=right_arrow, bg="#ADD8E6",
                    width=45, height=30, cursor="circle", relief="flat", borderwidth=0)
right_btn1.place(x=1007, y=554)

left_arrow = ImageTk.PhotoImage(Image.open("Icons/left_aro.png"))
left_btn1 = Button(profile_frame, image=left_arrow, bg="#ADD8E6",
                   width=45, height=30, cursor="circle", relief="flat", borderwidth=0)
...
age = Label(profile_frame, text="Age", font=(
    "Ariel", 17, "bold"), bg="#FCE9F1", fg="#3AA6B9")
...
# creating Entries to display user_interest and a scrollbar
user_interest = LabelFrame(profile_frame, width=220,
                           height=365, bg="blue", borderwidth=0)
...
def chat_wind():
    if chat_window.winfo_ismapped():
        chat_window.place_forget()  # Hide chat_window
    else:
...
chat_bottom_label = Label(chat_window, image=chat_bottom,
                          borderwidth=0, relief='flat')
...
microphone_frame = Canvas(chat_window, width=72, height=72,
                          bg="#FEA1A1", borderwidth=0, relief='flat')
...
match_frame.configure(width=1188, height=745, bg='#EEEEEE',
                      borderwidth=0, relief='flat')
...
match_user_frame.configure(width=1200, height=745,
                           borderwidth=0, relief='flat')
...
user_info.create_line(10, 150, 220, 150, fill="#164B60", width=3)
user_age = Entry(match_user_info, width=18, font="Arial, 15",
                 borderwidth=0, readonlybackground="#FCE9F1", fg="#FFA41B")
...
# creating Entries to display user_interest and a scrollbar
user_interest = LabelFrame(match_user_frame, width=220,
                           height=365, bg="blue", borderwidth=0)
...
back_match_btn = Button(match_user_frame, image=btn_match_back,
                        bg="#ADD8E6", relief="flat", borderwidth=0)

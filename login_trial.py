...
def signup():
    ...
    # Creating widgets (Label, Entry, Canvas=>line) be placed in "frame1"
    phone_no = Label(frame2, text="Phone_no", font=('Ariel', 15), fg="#8294C4", bg="#DBDFEA")
    phone_no.place(x=120, y=250)
    phone_no_entry = Entry(frame2, width=20, font='Ariel, 15', borderwidth=0, bg='#DBDFEA', fg='#ACB1D6')
    phone_no_entry.place(x=300, y=250)
    ...
    tick_comp = Button(frame3, image=tick_mark, bg="#DBDFEA", command=login_home, borderwidth=0)
